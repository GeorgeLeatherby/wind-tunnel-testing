...
print("Data of field Y in Position of Probe1: (extracted_data.Probe1.Position.Y)")
print(extracted_data.Probe1.Position.Y)
print("Data of field Z in Position of Probe1: (extracted_data.Probe1.Position.Z)")
print(extracted_data.Probe1.Position.Z)

print("Data of field X in Position of Probe2: (extracted_data.Probe2.Position.X)")
print(extracted_data.Probe2.Position.X)
print("Data of field Y in Position of Probe2: (extracted_data.Probe2.Position.Y)")
print(extracted_data.Probe2.Position.Y)
print("Data of field Z in Position of Probe2: (extracted_data.Probe2.Position.Z)")
print(extracted_data.Probe2.Position.Z)